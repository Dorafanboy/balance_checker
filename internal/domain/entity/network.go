...
type NetworkDefinition struct {
	...
	DEXScreenerChainID        string   `json:"dexScreenerChainId,omitempty" yaml:"dexScreenerChainId,omitempty"`               // Идентификатор сети для DEXScreener
	WrappedNativeTokenAddress string   `json:"wrappedNativeTokenAddress,omitempty" yaml:"wrappedNativeTokenAddress,omitempty"` // Адрес контракта обернутого нативного токена
